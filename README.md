...
<sub>CNCF DevStats counts [**4,733**](https://devstats.cluster.fun/?user=thc1006) contributions across CNCF projects. It's update automation and [My site](https://cs.nycu.edu.tw/~hctsai1006/open-source/) lists my open source contributions in detail.</sub>
