...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**3,001**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **209 pull requests across 62 projects.** 156 of them in 43 CNCF-hosted and Kubernetes-ecosystem repositories. |
