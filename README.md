...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**2,033**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **127 pull requests across 55 projects.** 102 of them in 39 CNCF-hosted and Kubernetes-ecosystem repositories. |
