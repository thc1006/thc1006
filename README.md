...
**Cloud-Native Telecom · Kubernetes DRA Correctnes**
...
When I find one bug, I look for the same bug pattern elsewhere. Many of my patches start that way. I include a regression test with the fix, and reviewers still catch things I missed.
...
I grew up in a fishing village in southern Taiwan. I organize the **O-RAN in B5G/6G** track at **[COSCUP](https://coscup.org/)** and give technical talks in Taiwanese. I help and alos want more people contribute to open source so that, together, we can make Taiwan and the World be better and better!!!
...
<sub>CNCF DevStats counts [**3,943**](https://devstats.cluster.fun/?user=thc1006) contributions across CNCF projects. It's update automation and [My site](https://cs.nycu.edu.tw/~hctsai1006/open-source/) lists my open source contributions in detail.</sub>
