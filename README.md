...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**2,047**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **128 pull requests across 55 projects.** 103 of them in 39 CNCF-hosted and Kubernetes-ecosystem repositories. |
