...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**3,095**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **213 pull requests across 62 projects.** 158 of them in 43 CNCF-hosted and Kubernetes-ecosystem repositories. |
