...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**2,436**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **167 pull requests across 60 projects.** 129 of them in 41 CNCF-hosted and Kubernetes-ecosystem repositories. |
