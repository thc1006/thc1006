...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**2,110**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **141 pull requests across 57 projects.** 111 of them in 40 CNCF-hosted and Kubernetes-ecosystem repositories. |
