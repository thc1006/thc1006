...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**3,370**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **226 pull requests across 62 projects.** 161 of them in 43 CNCF-hosted and Kubernetes-ecosystem repositories. |
