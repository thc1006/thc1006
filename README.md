...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**1,857**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **103 pull requests across 47 projects.** 81 of them in 40 CNCF-hosted and Kubernetes-ecosystem repositories. |
