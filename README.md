...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**2,285**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **154 pull requests across 60 projects.** 119 of them in 41 CNCF-hosted and Kubernetes-ecosystem repositories. |
