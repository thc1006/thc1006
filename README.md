...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**2,058**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **134 pull requests across 56 projects.** 109 of them in 40 CNCF-hosted and Kubernetes-ecosystem repositories. |
