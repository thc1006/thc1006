...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**2,502**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **188 pull requests across 60 projects.** 141 of them in 41 CNCF-hosted and Kubernetes-ecosystem repositories. |
