...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**2,346**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **162 pull requests across 60 projects.** 127 of them in 41 CNCF-hosted and Kubernetes-ecosystem repositories. |
