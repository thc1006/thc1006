...
|  |  |
| --- | --- |
| **CNCF DevStats** | [**2,846**](https://devstats.cluster.fun/?user=thc1006) |
| **Merged upstream** | **196 pull requests across 61 projects.** 148 of them in 42 CNCF-hosted and Kubernetes-ecosystem repositories. |
